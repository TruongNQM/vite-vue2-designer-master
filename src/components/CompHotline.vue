<template>
  <section class="section-hotline">
    <div class="section-hotline_block">
      <div class="hotline_phone">
        <a href="tel:0382744037">
          <div class="hotline-btn">
            ...
            <span>038 2744 037</span>
          </div>
        </a>
      </div>
      <div class="hotline_face">
        <a href="https://www.messenger.com/t/haiha.nguyen.16718">
          <div class="hotline-btn">
      ...
      <div class="hotline_zalo">
        <a href="https://zalo.me/0382744037">
          <div class="hotline-btn">
            <svg viewBox="0 0 56.69 56.69">
              <path
                fill="#fff"
...
.section-hotline_block:hover .hotline_phone,
.section-hotline_block:hover .hotline_face,
.section-hotline_block:hover .hotline_zalo {
  width: 220px;
}
